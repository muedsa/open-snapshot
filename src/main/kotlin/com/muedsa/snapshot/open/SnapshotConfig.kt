...
internal data class ImageLimits(
    ...
    /** 单次渲染中所有 URL/Data URI 图片的解码像素总和上限。 */
    val maxTotalImagePixels: Long,
...
internal class SnapshotConfig(
    ...
    val maxDocumentElements: Int,
    val maxDocumentDepth: Int,
...
internal object SnapshotConfigLoader {
    ...
    fun load(config: ApplicationConfig, env: (String) -> String? = System::getenv): SnapshotConfig {
        ...
        val config = SnapshotConfig(
            ...
            maxDocumentElements = positiveInt("snapshot.max-document-elements", 4096),
            maxDocumentDepth = positiveInt("snapshot.max-document-depth", 128),
            canvas = CanvasLimits(
            ...
            image = ImageLimits(
                ...
                maxTotalImagePixels = positiveLong("snapshot.image.max-total-image-pixels", 16_777_216L),
